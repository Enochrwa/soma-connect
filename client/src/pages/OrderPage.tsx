...
import { Loader2, Package, MapPin, CheckCircle, Circle, Clock } from "lucide-react";
...
export default function OrderPage() {
  ...
  const currentStep = STATUSES.indexOf(order.status as OrderStatus);
    ...
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      ...
      {order.status !== "cancelled" && (
        <div className="bg-white rounded-2xl shadow-card p-6">
          <h2 className="font-display font-bold text-forest mb-5">Order tracking</h2>
